...
* **Монотонный анимированный фон**: Живые плавающие фигуры на главном экране и в списках, создающие эффект глубины.
* **Material 3 Expressive**: Экраны коллекций открываются цветным блоком с обложкой, списки треков собраны в общие контейнеры, а загрузка везде показывается фирменным индикатором Google (`LoadingIndicator`, волнистые индикаторы прогресса).
