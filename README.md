...
* Нажмите на трек, чтобы открыть полноэкранный плеер: обложка на всю ширину экрана и цветная панель управления в стиле Material 3 Expressive. Мини-плеер внизу экрана — это та же панель в свёрнутом виде.
...
* **Альбомы в медиатеке**: Сердечко на странице альбома сохраняет его в «Мою музыку» рядом со «Скачанным». Там альбом можно скачать целиком — треки ложатся на устройство, но в «Скачанное» не попадают.
* **Оформление**: В настройках включается и выключается живой фон (фигуры реагируют на наклон и тряску телефона) и цвета плеера из обложки трека.
* **Обновления**: Приложение само проверяет релизы на GitHub раз в 12 часов и предлагает скачать и установить новую версию (Настройки → Обновления).
...
* **Объёмный фон**: Фигуры Material 3 Expressive в тон системы, со светом, тенями и глубиной резкости; наклон телефона сдвигает их по глубине, тряска раскачивает (акселерометр).
* **Material 3 Expressive**: Главная — одна обложка по центру, соседи сжимаются в полоски, категории в плавающей панели снизу. Страница артиста открывается портретом во всю ширину, миксы и станции — обложкой-фоном с большой кнопкой play. Большие панели — тоном виджетов лаунчера, а не ярким акцентом; загрузка везде показывается фирменным индикатором Google (`LoadingIndicator`, волнистые индикаторы прогресса).
* **Цвета плеера из обложки**: Преобладающий цвет обложки становится фоном плеера, самый яркий — его кнопками; меняется вместе с тёмной и светлой темой устройства.
